...
const mockResults = [
  {
    id: 1,
    title: "Law on Obligations, Article 154",
    type: "LAW",
    jurisdiction: "RS",
    date: "2020-03-15",
    relevance: 0.94,
    passages: [
      "Whoever causes damage to another is liable to compensate it...",
      "For damage arising from things or activities that pose increased danger..."
    ],
  },
  {
    id: 2,
    title: "Supreme Court of Cassation, Rev 1234/2022",
    type: "CASE",
    jurisdiction: "RS",
    court: "VKS",
    date: "2022-11-08",
    relevance: 0.89,
    passages: [
      "The burden of proving causal link lies with the plaintiff...",
      "The court correctly applied the rule on shifting the burden of proof..."
    ],
  },
  {
    id: 3,
    title: "Commentary on Law on Obligations - Prof. Perović",
    type: "DOCTRINE",
    jurisdiction: "RS",
    date: "2018-01-01",
    relevance: 0.82,
    passages: [
      "Causal link as an element of liability for damage represents...",
    ],
  },
];
