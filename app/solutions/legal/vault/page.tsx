          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-2xl font-display text-text-bright">Legal Vault</h1>
            ...
            <div className="flex gap-3">
              <div className="flex-1 relative">
                <input
                  ...
                  placeholder="Search your legal corpus… (e.g., 'burden of proof causation damages')"
              ...
              <button
                ...
                className="px-6 py-3 bg-phosphor text-void font-mono text-sm rounded-lg hover:bg-phosphor-dim transition-colors"
              >
                Search
              </button>
            </div>
