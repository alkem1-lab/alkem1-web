...
export function DemoBar({ vertical, onLoadScenario, onRunWorkflow }: DemoBarProps) {
  ...
  return (
    <motion.div
      ...
      className={`fixed top-16 right-6 z-50 rounded-2xl border backdrop-blur-md ${
    ...
    >
      ...
      <div className="flex items-center gap-3 p-3">
        {/* Badge */}
        <div className="text-[10px] px-2 py-1 rounded-full border border-amber-400/30 bg-amber-400/10 text-amber-400 uppercase tracking-wider">
          Demo Mode • Simulated
        </div>

        {/* Scenario Selector */}
        <select
          className="bg-surface-1 text-sm border border-border-subtle rounded-lg px-3 py-2 text-text-body focus:outline-none focus:border-phosphor/50"
          value={scenarioId}
        ...
        <button
          ...
          className="px-3 py-2 text-sm font-mono rounded-lg border border-border-subtle hover:border-phosphor/50 hover:text-phosphor transition-colors text-text-body"
        >
          Load
        </button>
        <button
        ...
        <button
          onClick={showProof}
          className="px-3 py-2 text-sm font-mono rounded-lg border border-neural-2/50 bg-neural-2/10 text-neural-2 hover:bg-neural-2/20 transition-colors"
        >
          Proof
        </button>
